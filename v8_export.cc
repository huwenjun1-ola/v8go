...
void (*goTickFuncEntry)(int32_t);

void (*goSendMessageFuncEntry)(int32_t, const char *);
///
using namespace v8;
...
void InitV8Go(m_ctx *(*getGoContextFuncIn)(int), ValuePtr (*goFunctionCallbackIn)(int, int, ValuePtr *, int),
              void (*goTickFuncIn)(int32_t), void (*goSendMessageFunIn)(int32_t, const char *)) {
    getGoContextFuncEntry = getGoContextFuncIn;
    goFunctionCallbackEntry = goFunctionCallbackIn;
    goTickFuncEntry = goTickFuncIn;
    goSendMessageFuncEntry = goSendMessageFunIn;
}
